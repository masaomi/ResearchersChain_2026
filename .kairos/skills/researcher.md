...
## Quality Guardrails
- **Statistical**: State test assumptions. Report effect sizes and confidence intervals.
  Apply multiple testing correction. Justify sample sizes.
